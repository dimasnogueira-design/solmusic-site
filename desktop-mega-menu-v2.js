(()=>{
  ...
  const setup=()=>{
    ...
    if(tabs){
      tabs.innerHTML=`
        <button class="mega-tab mega-card is-active" type="button" style="--mega-img:url('IMG_4713.png')"><span>Guitarras</span></button>
        <button class="mega-tab mega-card" type="button" style="--mega-img:url('IMG_4714.png')"><span>Baixos</span></button>
        <button class="mega-tab mega-card" type="button" style="--mega-img:url('IMG_4715.png')"><span>Violões</span></button>
        <button class="mega-tab mega-card" type="button" style="--mega-img:url('IMG_4716.png')"><span>Baterias</span></button>
        <button class="mega-tab mega-card" type="button" style="--mega-img:url('IMG_4717.png')"><span>Amplificadores</span></button>
        <button class="mega-tab mega-card" type="button" style="--mega-img:url('IMG_4718.png')"><span>Pedais & Efeitos</span></button>`;
    }
